...
import "../../styles/PaymentMethoCross.css"
import Cross from "../../assets/cross.png"
import Footer from "../Footer"
import { useNavigate } from "react-router-dom"

const PaymentMethodCross = () => {
    ...
    return (
        <div>
            <Header />
            <div className="title">
                <h1>Assinar Plano De CrossFir</h1>
            </div>
            <div className="totalCross">
                <form>
                ...
                <div className="img">
                    ...
                    <div className="box">
                        <div className="pix">
                            <button type="button" onClick={PixCross}>
                        ...
                        <div className="bill">
                            <button type="button" onClick={BoletCross}>
...
export default PaymentMethodCross