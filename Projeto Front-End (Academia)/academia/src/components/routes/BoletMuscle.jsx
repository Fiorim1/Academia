...
import "../../styles/BoletMuscle.css"
import Bolet from "../../assets/bolet.png"
import Download from "../../assets/dowload.png"
import { useNavigate } from "react-router-dom"

function BoletMuscle() {
    ...
    return (
        <div>
            <Header />
            <div className="boletMuscle">
                <div className="titleBoletMuscle">
