...
import "../../styles/PaymentMethoBoxe.css"
import Boxe from "../../assets/boxe.png"
import Footer from "../Footer"
import { useNavigate } from "react-router-dom"

const PaymentMethodBoxe = () => {
    ...
    return (
        <div>
            <Header />
            <div className="title">
                <h1>Assinar Plano De Boxe</h1>
            </div>
            <div className="totalBoxe">
                <form>
                ...
                <div className="img">
                    ...
                    <div className="box">
                        <div className="pix">
                            <button type="button" onClick={PixBoxe}>
                        ...
                        <div className="bill">
                            <button type="button" onClick={BoletBoxe}>
...
export default PaymentMethodBoxe