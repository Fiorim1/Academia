...
const TrainingCross = () => {
  ...
  const [workouts, setWorkouts] = useState([
    { id: 1, day: 'Segunda', exercise: 'Snatch', sets: 4, reps: 10 },
    { id: 2, day: 'Terça', exercise: 'Clean', sets: 3, reps: 12 },
    { id: 3, day: 'Quarta', exercise: 'Jerk', sets: 3, reps: 15 },
    { id: 4, day: 'Quinta', exercise: 'Shoulder press', sets: 4, reps: 8 },
    { id: 5, day: 'Sexta', exercise: 'Push press', sets: 5, reps: 8 }
  ]);
